...
router.route('/api/courses/:courseId/lesson/new')
  .put(
    authCtrl.requireSignin, // Middleware to require authentication
    courseCtrl.isInstructor, // Middleware to check if user is the instructor
    upload.single('pdf'), // Multer middleware to handle PDF upload
    courseCtrl.newLesson // Controller function to add a new lesson
  );
